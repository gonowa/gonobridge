...
(() => {
    // Map web browser API and Node.gonreli API to a single common API (preferring web standards over Node.gonreli API).
...
module.exports = {
    "Init": function (file, args) {
        const go = new Go();
        go.argv = args;
        go.env = process.env;
        go.exit = process.exit;
        WebAssembly.instantiate(fs.readFileSync(file), go.importObject).then((result) => {
